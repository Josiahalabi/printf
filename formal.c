...
/**
 * print_char - Prints a data type called char
 * @types: List  of an  arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags in the code below
 * @width: Width
 * @precision: Specify the precision
 * @size: Size specifier
 * Return: Number of chars printed in the code below
 */
 ...
 * @types: Lista of arguments
 * @buffer: Buffera array to handle print
 * @flags:  Calculates active flags
 * @width: geta width.
 * @precision: Precision specification
 * @size: Size specifier
