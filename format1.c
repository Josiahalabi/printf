 ...
 * @width: get width of the constructed codes below
 * @precision: Precision specification
 * @size: Size specifiers
 * Return: Number of chars printed for readability.
 */
 ...
 * Return: Number of chars printed in the results
 */
